        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2 space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
              Conectando a toda la <span className="text-q10-blue">comunidad educativa</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-600">
              Q10 es la plataforma educativa que integra a colegios, profesores, padres y estudiantes en un solo lugar.
            </p>
            <div className="flex flex-wrap gap-4">
              <Button className="bg-q10-blue hover:bg-q10-dark-blue text-white text-lg py-6 px-8">
                Solicitar Demo
              </Button>
              <Button variant="outline" className="border-q10-blue text-q10-blue hover:bg-q10-blue hover:text-white text-lg py-6 px-8">
                Conocer Más
              </Button>
            </div>
          </div>
          <div className="md:w-1/2 relative">
            <div className="w-full h-full rounded-lg overflow-hidden shadow-xl animate-float">
              <div className="bg-q10-blue/10 p-6 rounded-lg">
                <div className="bg-white rounded-lg shadow-lg p-6">
                  <div className="h-8 w-32 bg-q10-blue/20 rounded mb-4"></div>
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-4">
                    <div className="h-20 bg-q10-blue/10 rounded"></div>
